...
<!--   <ASIDE style='float: left;'>
  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do' 
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='id' id='id' value='member' required="required" style='width: 30%;' placeholder="아이디" autofocus="autofocus">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='mname' id='mname' 
                   value='짱구' required="required" style='width: 30%;' placeholder="성명">
      </div>
    </div>   
     ...
     <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='s_word' id='s_word' 
                   value='#회원' required="required" style='width: 80%;'>
      </div>
    </div>   
