...
<br>
  ...
  <div class='menu_line'></div><br>
   ...
   <DIV class='title_line'>회원 정보 수정</DIV><br>
  ...
  <FORM name='frm' method='POST' action='./update.do'
      ...
      <div class="form-group" style='font-size:15px;'> 
        ...
        아이디</label>
        <div class="col-md-11">
          <textarea class="form-control input-md" name="id" id="id" rows='1'>${memberVO.id }></textarea>
        </div>
      </div>   
      ...
      <div class="form-group" style='font-size:15px;'>   
        ...
        <div class="col-md-11">
          <textarea class="form-control input-md" name="mname" id="mname"  rows='1'>${memberVO.mname }</textarea>
        </div>
      </div>
        ...
        <div class="col-md-11">
          ...
          <c:choose>
            <c:when test="${fn:endsWith(files, '.jpg')}">
              <IMG id='files' src='./storage/${memberVO.files}' style='width: 20%;'>
            </c:when>
            <c:when test="${fn:endsWith(files, '.png')}">
              <IMG id='files' src='./storage/${memberVO.files}' style='width: 20%;'>
            </c:when>
            <c:when test="${memberVO.files.length() > 0}">
              ${memberVO.files }  <!-- 이미지가 아니면서 파일이 존재하는 경우 파일명 출력 -->
            </c:when>
          </c:choose>
        </div>
      </div>
      <div class="form-group" style='font-size:15px;'>   
       ...
       <div class="form-group" style='font-size:15px;'>   
        ...
        <div class="col-md-11">
          <textarea class="form-control input-md" name="tel"id="tel" rows='10'>${memberVO.tel }</textarea>
        </div>
      </div>
      ...
      <div class="form-group" style='font-size:15px;'>   
        ...
        <div class="col-md-11">
          <textarea class="form-control input-md" name="address1" id="address1"  rows='10'>${memberVO.address1}</textarea>
        </div>
      </div>
      ...
      <div class="form-group" style='font-size:15px;'>   
        ...
        <div class="col-md-11">
          <textarea class="form-control input-md" name="address2" id="address2"  rows='10'>${memberVO.address2}</textarea>
        </div>
      </div>  
